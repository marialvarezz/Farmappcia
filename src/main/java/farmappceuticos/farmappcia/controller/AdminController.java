...
public class AdminController {
    ...
    public String showMedicines(Model model,
        ...
        Page<Medicine> medicinePageAdmin = medicineService.findAll(PageRequest.of(currentPage - 1, pageSize));

        model.addAttribute("medicinePageAdmin", medicinePageAdmin);
        int totalPages = medicinePageAdmin.getTotalPages();
        if (totalPages > 0){
